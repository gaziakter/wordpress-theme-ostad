...
add_action( 'harry_header_before' , 'harry_header' );
...
function harry_logo(){ 
    ...
    <a class="tp-page-logo" href="<?php echo esc_url(home_url('/')); ?>">
        <img src="<?php echo esc_url($page_logo['url']); ?>" alt="<?php echo bloginfo(); ?>">
    </a>
    <?php else: ?>
    <a class="tp-main-logo" href="<?php echo esc_url(home_url('/')); ?>">
...
function footer_copyright(){
    ...
    ?>
        <p><?php echo harry_kses($footer_copyright); ?></p>
    <?php
}
